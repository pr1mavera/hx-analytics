...
var ha = (function () {
	...
	***************************************************************************** */
	...
	var Report = /** @class */ (function () {
	    function Report(eventSubscriber) {
	        // 模式类型
	    ...
	    Report = __decorate([
	        ...
	        injectable(),
	        __param(0, inject(TYPES.EventSubscriber)),
	...
	var ReportStrategy = /** @class */ (function () {
	    function ReportStrategy(_) {
	        ...
	        // 合并用户信息、设备信息
	        var _a = this._.deviceInfo(), name = _a.name, version = _a.version, browser = _a.browser, connType = _a.connType;
	        this.info = __assign(__assign({}, user), { batchId: this._.createVisitId(user.appId), clientType: browser, sysVersion: name + " " + version, userNetWork: connType });
	    }
